    ...
    private func bindViewModel() {
        ...
        output.result
            ...
            .sink { [weak self] result in
                ...
                case .loadMore(let firtIndex, let lastIndex): performLoadMore(firtIndex: firtIndex,
                                                                              lastIndex: lastIndex)
                case .search(let endSearching): performSearch(endSearching: endSearching)
...
// MARK: Function
extension ListPhotoViewController {
    private func showIndicator(status: Bool) {
    ...
    private func performSearch(endSearching: Bool) {
        self.photoTableView.reloadData()
        if !endSearching {
    ...
    private func performLoadMore(firtIndex: Int, lastIndex: Int) {
